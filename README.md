...
| CSV exports (task / history) | admins | admins — the CSV is generated by `lib/actions/export.ts`, which rejects anybody else; an inspector's phone only points to Dashboard → Tasks |
